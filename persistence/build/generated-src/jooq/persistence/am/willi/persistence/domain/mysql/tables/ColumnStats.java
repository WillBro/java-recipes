...
public class ColumnStats extends TableImpl<ColumnStatsRecord> {
    ...
    private static final long serialVersionUID = 468084687;
     ...
     */
    public final TableField<ColumnStatsRecord, ColumnStatsHistType> HIST_TYPE = createField("hist_type", org.jooq.impl.SQLDataType.VARCHAR(14).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(am.willi.persistence.domain.mysql.enums.ColumnStatsHistType.class), this, "");
