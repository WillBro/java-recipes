...
public class Func extends TableImpl<FuncRecord> {
    ...
    private static final long serialVersionUID = 1703434791;
     ...
     */
    public final TableField<FuncRecord, FuncType> TYPE = createField("type", org.jooq.impl.SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(am.willi.persistence.domain.mysql.enums.FuncType.class), this, "");
