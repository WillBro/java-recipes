...
import am.willi.persistence.domain.performance_schema.tables.records.SocketInstancesRecord;
...
public class SocketInstances extends TableImpl<SocketInstancesRecord> {
    ...
    private static final long serialVersionUID = 640881196;
     ...
     */
    public final TableField<SocketInstancesRecord, SocketInstancesState> STATE = createField("STATE", org.jooq.impl.SQLDataType.VARCHAR(6).nullable(false).asEnumDataType(am.willi.persistence.domain.performance_schema.enums.SocketInstancesState.class), this, "");
