...
import am.willi.persistence.domain.performance_schema.tables.records.SetupTimersRecord;
...
public class SetupTimers extends TableImpl<SetupTimersRecord> {
    ...
    private static final long serialVersionUID = 679814278;
     ...
     */
    public final TableField<SetupTimersRecord, SetupTimersTimerName> TIMER_NAME = createField("TIMER_NAME", org.jooq.impl.SQLDataType.VARCHAR(11).nullable(false).asEnumDataType(am.willi.persistence.domain.performance_schema.enums.SetupTimersTimerName.class), this, "");
