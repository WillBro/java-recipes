...
import am.willi.persistence.domain.performance_schema.tables.records.HostCacheRecord;
...
public class HostCache extends TableImpl<HostCacheRecord> {
    ...
    private static final long serialVersionUID = 1664071357;
     ...
     */
    public final TableField<HostCacheRecord, HostCacheHostValidated> HOST_VALIDATED = createField("HOST_VALIDATED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(am.willi.persistence.domain.performance_schema.enums.HostCacheHostValidated.class), this, "");
