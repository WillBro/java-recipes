...
public class Event extends TableImpl<EventRecord> {
    ...
    private static final long serialVersionUID = 1088828662;
     ...
     */
    public final TableField<EventRecord, EventIntervalField> INTERVAL_FIELD = createField("interval_field", org.jooq.impl.SQLDataType.VARCHAR(18).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(am.willi.persistence.domain.mysql.enums.EventIntervalField.class), this, "");
     ...
     */
    public final TableField<EventRecord, EventStatus> STATUS = createField("status", org.jooq.impl.SQLDataType.VARCHAR(18).nullable(false).defaultValue(org.jooq.impl.DSL.field("'ENABLED'", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(am.willi.persistence.domain.mysql.enums.EventStatus.class), this, "");

    /**
     * The column <code>mysql.event.on_completion</code>.
     */
    public final TableField<EventRecord, EventOnCompletion> ON_COMPLETION = createField("on_completion", org.jooq.impl.SQLDataType.VARCHAR(8).nullable(false).defaultValue(org.jooq.impl.DSL.field("'DROP'", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(am.willi.persistence.domain.mysql.enums.EventOnCompletion.class), this, "");
