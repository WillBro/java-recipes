...
import am.willi.persistence.domain.performance_schema.tables.records.SetupInstrumentsRecord;
...
public class SetupInstruments extends TableImpl<SetupInstrumentsRecord> {
    ...
    private static final long serialVersionUID = -1713862429;
     ...
     */
    public final TableField<SetupInstrumentsRecord, SetupInstrumentsEnabled> ENABLED = createField("ENABLED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(am.willi.persistence.domain.performance_schema.enums.SetupInstrumentsEnabled.class), this, "");

    /**
     * The column <code>performance_schema.setup_instruments.TIMED</code>.
     */
    public final TableField<SetupInstrumentsRecord, SetupInstrumentsTimed> TIMED = createField("TIMED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(am.willi.persistence.domain.performance_schema.enums.SetupInstrumentsTimed.class), this, "");
